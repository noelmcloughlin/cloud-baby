...
class AutoScale:
    ...
    def __init__(self, service='autoscaling', region='eu-west-1', zone='eu-west-1a', tag=default_desc, cidr='172.35.0.0/24'):
        """
        Initialise data for Cloud AutoScale
        """

        self.client = boto3.client('autoscaling')
        self.compute = boto3.resource('autoscaling', region)
...
'''
        ...
        self.data = {'LaunchConfigurationName: uuid.uuid4(),
                     'ImageId': self.ami_id,
    ...
    def create_tag(self, resource, tag_key, tag_value, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_tags
        """
        try:
...
class LaunchConfiguration(AutoScale):
    """
    LAUNCH CONFIGURATION
    """

    def __init__(self, dry=False, name='launch-configuration-tag', desc=default_desc, zone='eu-west-1a', ami_id=None,
                 instance_type=None, key_name=None):
        """
        Initialize and create Launch template
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_launch_template
        """
        try:
            super().__init__('launch-configuration')
            ...
            self.response = self.client.create_launch_template(LaunchConfigurationName=name, VersionDescription=desc,
                                                               LaunchConfigurationData=self.data, DryRun=dry)
            self.create_tag(self.response['LaunchConfiguration']['LaunchConfigurationId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, tid, tname, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_launch_template
        """
        try:
            print('Delete launch_template %s %s' % ((tid if tid else ''), (tname if tname else ''))),
            if tid:
                return self.client.delete_launch_template(LaunchConfigurationId=tid, DryRun=dry)
            else:
                return self.client.delete_launch_template(LaunchConfigurationName=tname, DryRun=dry)
        except ClientError as err:
            AutoScale.handle(err)
        except Exception as err:
            AutoScale.fatal(err)

    def list(self, name='tag:launch-configuration-tag', values=(default_desc,), dry=False):
        """
        Get EC2 launch_templates by searching filters
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_launch_templates
        """
        try:
...
class Instance(AutoScale):
    ...
    def __init__(self, template_id, subnet_id, sg_ids, zone, max_count=1, min_count=1):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.ServiceResource.create_instances
        """
        try:
            super().__init__('instance')
            print('Create Instance from %s' % template_id )
            instance = self.compute.create_instances(LaunchConfiguration={'LaunchConfigurationId': template_id},
    ...
    def list(self, name='tag:instance-tag', values=(default_desc,), name2=None, values2=(), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_instances
        """
        try:
...
class Volumes(AutoScale):
    ...
    def __init__(self, zone, size, snapshot_id=None, volume_type='default', dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_volume
        """
        try:
            ...
            if id:
                ...
                self.response = self.client.create_instances(AvailabilityZone=zone, Size=size, VolumeType=volume_type,
                                                             DryRun=dry)
            self.create_tag(self.response['VolumeId'], self.tag, self.tagdesc, dry)
        except ClientError as err:
            AutoScale.handle(err)
        except Exception as err:
            AutoScale.fatal(err)
    ...
    def delete(self, volume_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_volume
        """
        try:
    ...
    def list(self, name='tag:volume-tag', values=(default_desc,), dry=False):
        """
        Get Volumes
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_volumes
        """
        try:
...
class Vpc(AutoScale):
    ...
    def __init__(self, cidr_ipv4, auto_ipv6=True, tenancy='default', dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_vpc
        """
        try:
            super().__init__('vpc')
            ...
            self.create_tag(self.response['Vpc']['VpcId'], self.tag, self.tagdesc, dry)
        except ClientError as err:
            AutoScale.handle(err, 'vpc')
        except Exception as err:
            AutoScale.fatal(err)
    ...
    def delete(self, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_vpc
        """
        try:
    ...
    def list(self, name='tag:vpc-tag', values=(default_desc,), dry=False):
        """
        Get VPC(s) by filter
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_vpcs
        """
        try:
...
class VpcEndpoint(AutoScale):
    """
    VPC ENDPOINTS
    """

    def __init__(self, vpc_id, rtt_ids, sn_ids, sg_ids, ideal, svc='com.amazonaws.eu-west-1.autoscaling', dry=False):
        """
        Initialize and create VpcEndPoint
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_vpc_endpoint
        """
        try:
            ...
            self.create_tag(self.response['VpcEndpoint']['VpcEndpointId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, vpc_endpoint_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_vpc_endpoints
        """
        try:
    ...
    def list(self, name='tag:vpc-endpoint-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_vpc_endpoints
        """
        try:
...
class VpcPeeringConnection(AutoScale):
    """
    ...
    def __init__(self, peer_vpc_id, vpc_id, region, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_vpc_peering_connection
        """
        try:
            ...
            self.create_tag(self.response['VpcPeeringConnection']['VpcPeeringConnectionId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, vpc_peering_connection_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_vpc_peering_connections
        """
        try:
    ...
    def list(self, name='tag:vpc-peering-connection-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_vpc_peering_connections
        """
        try:
...
class NetworkInterface(AutoScale):
    """
    NETWORK INTERFACE
    """
    ...
    def __init__(self, desc, groups=None, pri_ip=None, pri_ips=None, subnet_id=None, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_network_interface
        """
        try:
            ...
            self.response = self.client.create_network_interface(Description=desc, Groups=groups, SubnetId=subnet_id,
                                                                 ...
                                                                 DryRun=dry)
            self.create_tag(self.response['NetworkInterface']['NetworkInterfaceId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, if_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_network_interface
        """
        try:
    ...
    def list(self, name='tag:network-interface-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_network_interfaces
        """
        try:
...
class Subnet(AutoScale):
    ...
    def __init__(self, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_subnet
        """
        try:
            super().__init__('subnet')
            self.response = self.client.create_subnet(CidrBlock=self.cidr_block, VpcId=vpc_id, DryRun=dry)
            self.create_tag(self.response['Subnet']['SubnetId'], self.tag, self.tagdesc, dry)
    ...
    def modify_attr(self, sn_id, value):
        """
        Modify a subnet.
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.modify_subnet_attribute
        """
        try:
    ...
    def delete(self, sn_id, dry=False):
        """
        Delete a subnet.
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_subnet
        """
        try:
    ...
    def list(self, name='tag:subnet-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_subnets
        """
        try:
...
class SecurityGroup(AutoScale):
    ...
    def __init__(self, name, desc, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_security_group
        """
        try:
            ...
            self.response = self.client.create_security_group(Description=desc, GroupName=name, VpcId=vpc_id,
                                                              DryRun=dry)
            self.create_tag(self.response['GroupId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, sg_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_security_group
        """
        try:
    ...
    def list(self, name='tag:security-group-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_security_groups
        """
        try:
    ...
    def list_refs(self, group_ids, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_security_group_references
        """
        try:
    ...
    def auth_egress(self, from_port, to_port, proto, sg_id, ipv4, ipv6=({'CidrIpv6', '::/0'},), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.authorize_security_group_egress
        """
        try:
    ...
    def auth_ingress(self, from_port, to_port, proto, sg_id, ipv4, ipv6=({'CidrIpv6', '::/0'},), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.authorize_security_group_ingress
        """
        try:
    ...
    def revoke_egress(self, from_port, to_port, proto, sg_id, ipv4, ipv6=({'CidrIpv6', '::/0'},), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.revoke_security_group_egress
        """
        try:
    ...
    def revoke_ingress(self, from_port, to_port, proto, sg_id, ipv4, ipv6=({'CidrIpv6', '::/0'},), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.revoke_security_group_ingress
        """
        try:
...
class NatGateway(AutoScale):
    ...
    def __init__(self, alloc_id, subnet_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_nat_gateway
        """
        try:
            ...
            self.create_tag(self.response['NatGateway']['NatGatewayId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, nat_gw_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_nat_gateway
        """
        try:
    ...
    def list(self, name='tag:nat-gateway-tag', values=(default_desc,)):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_nat_gateways
        """
        try:
...
class RouteTable(AutoScale):
    ...
    def __init__(self, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_route_table
        """
        try:
            super().__init__('route-table')
            self.response = self.client.create_route_table(VpcId=vpc_id, DryRun=dry)
            self.create_tag(self.response['RouteTable']['RouteTableId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, route_table_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_route_table
        """
        try:
    ...
    def create_route(self, version, cidr, gateway_id, route_table_id, dry=False):
        """
        Initialize and Create Route Table
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_route
        """
        try:
    ...
    def delete_route(self, cidr, route_table_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_route
        """
        try:
    ...
    def associate(self, route_table_id, subnet_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.associate_route_table
        """
        try:
    ...
    def disassociate(self, association_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.disassociate_route_table
        """
        try:
    ...
    def list(self, name='tag:route-table-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_route_tables
        """
        try:
...
class NetworkAcl(AutoScale):
    ...
    def __init__(self, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_network_acl
        """
        try:
            super().__init__('network-acl')
            self.response = self.client.create_network_acl(VpcId=vpc_id, DryRun=dry)
            self.create_tag(self.response['NetworkAcl']['NetworkAclId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, network_acl_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_network_acl
        """
        try:
    ...
    def replace_association(self, network_acl_id, association_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.replace_network_acl_association
        """
        try:
    ...
    def create_entry(self, network_acl_id, num, action, cidr, from_port, to_port, proto='6', egress=False, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_network_acl_entry
        """
        try:
    ...
    def delete_entry(self, network_acl_id, num=100, egress=False, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_network_acl_entry
        """
        try:
            print('Delete %s %s' % (network_acl_id, ('(dry)' if dry else '')))
    ...
    def list(self, name='tag:network-acl-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_network_acls
        """
        try:
...
class ElasticIp(AutoScale):
    ...
    def __init__(self, domain='vpc', dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.allocate_address
        """
        try:
            super().__init__('elastic-ip')
            self.response = self.client.allocate_address(Domain=domain, DryRun=dry)
            self.create_tag(self.response['AllocationId'], self.tag, self.tagdesc, dry)
    ...
    def associate(self, alloc_id, instance_id, dry=False):
        """
        Associate elastic ip with autoscaling_instance
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.associate_address
        """
        try:
    ...
    def disassociate(self, association_id, dry=False):
        """
        Disassociate elastic ip with autoscaling_instance
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.disassociate_address
        """
        try:
    ...
    def release(self, alloc_id, dry=False):
        """
        Delete a elastic ip.
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.release_address
        """
        try:
    ...
    def list(self, name='tag:elastic-ip-tag', values=(default_desc,), dry=False):
        """
        Get Elastic IPs
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_addresses
        """
        try:
...
class InternetGateway(AutoScale):
    """
    INTERNET GATEWAY
    """
    ...
    def __init__(self, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.create_internet_gateway
        """
        try:
            super().__init__('internet-gateway')
            self.response = self.client.create_internet_gateway(DryRun=dry)
            self.create_tag(self.response['InternetGateway']['InternetGatewayId'], self.tag, self.tagdesc, dry)
    ...
    def delete(self, gateway_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.delete_internet_gateway
        """
        try:
    ...
    def list(self, name='tag:internet-gateway-tag', values=(default_desc,), dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.describe_internet_gateways
        """
        try:
    ...
    def attach(self, gateway_id, vpc_id, dry=False):
        ...
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.attach_internet_gateway
        """
        try:
    ...
    def detach(self, gateway_id, vpc_id, dry=False):
        """
        Attaches an internet gateway to a VPC
        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#EC2.Client.detach_internet_gateway
        """
        try:
